...
# spark-submit --jars /home/Arthur/Downloads/postgresql-42.5.0.jar Scripts_pyspark_atividade_3.py -t parquet -i /home/Arthur/download/Atividades/Produtos.parquet -n produtos -b vendas
